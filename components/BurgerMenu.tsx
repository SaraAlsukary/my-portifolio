...
export default BurgerMenu;      .forEach(section => observer.observe(section));
            ...
            <nav className="w-full font-poppins-medium text-[1.5rem] absolute top-full left-0">
                <ul
                    className={`
                        ...
                        transition-all duration-500 ease-in-out overflow-hidden  ${open ? "max-h-125 pt-6 pb-10" : "max-h-0 "} `}
                >
